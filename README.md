...
## 🚀 Roadmap (SMART Objectives)

- [ ] **Week 5:** Finalize user authentication and core file upload handling.
- [ ] **Week 9:** Deliver the interactive sprite canvas viewer that successfully cycles frames from an uploaded spritesheet.
- [ ] **Week 14:** Deploy the fully functional web application.
